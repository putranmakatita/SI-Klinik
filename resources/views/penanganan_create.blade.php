...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Add Penanganan</h1>
</div>
<a href="/penanganan" class="btn btn-warning">←Kembali</a>
<div class="col-lg-10">
    <form method="post" action="/penanganan">
        @csrf
        ...
        <div class="mb-3">
            ...
            <select id="tindakan" class="form-select @error('tindakan_id') is-invalid @enderror" name="tindakan_id">
                ...
                @if(old('tindakan_id') == $tindakan->id)
        ...
        <button type="submit" class="btn btn-primary">Tambahkan Penanganan</button>
    </form>
</div>
