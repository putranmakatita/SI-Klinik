...
<div class="col-lg-10">
    <form method="post" action="/pasien/{{$pasien->id}}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('usia') is-invalid @enderror" id="usia" name="usia" value="{{ old('usia', $pasien->usia) }}" required autofocus>
        @error('usia')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('no_rekmed') is-invalid @enderror" id="no_rekmed" name="no_rekmed" value="{{ old('no_rekmed', $pasien->no_rekmed) }}" required autofocus>
        @error('no_rekmed')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
